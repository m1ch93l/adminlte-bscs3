...
<body>
    ...
    <a href="#" class="brand-link logo-switch">
        <img src="memyself.jpg" alt="AdminLTE Docs Logo Small" class="brand-image-xl logo-xs">
        <img src="memyself.jpg" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="image">
            <img src="memyself.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
